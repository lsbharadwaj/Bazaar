...
class StoreWithContactSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ['name','contact_no','shop_img','url','products']

class ProductSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Product
        fields = ['title', 'description','price','url','product_img','store']
...
class ManageProductSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Product
        fields = ['title', 'description','price','url','publish','product_img']
